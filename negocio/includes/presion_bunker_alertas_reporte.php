<?php
    require_once($_SERVER['DOCUMENT_ROOT'].'/calderas/negocio/presion_bunker_alertas_reporte.php');
?>
...
<script type="text/javascript">
    ...
    function refrescarGrafica(chart) {
        $.ajax({
            ...
            data: {"calderaId": $("input[name='filtroCaldera']:checked").val(), "fechaInicio": $("#fechaInicio").val(), "fechaFin": $("#fechaFin").val()}
	    }).done(function(msg) {
            //console.log(msg);
